<!--header-->
  <h3 class="floated"><?php echo i18n_r(self::FILE.'/TITLE_COMMENT_TEMPLATE'); ?></h3>
  <div class="edit-nav">
    ...
    <a href="load.php?id=<?php echo self::FILE; ?>&template=comments" class="current"><?php echo i18n_r(self::FILE.'/COMMENTS'); ?></a>
