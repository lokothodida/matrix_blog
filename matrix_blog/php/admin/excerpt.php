<!--header-->
  <h3 class="floated"><?php echo i18n_r(self::FILE.'/TITLE_EXCERPT'); ?></h3>
  <div class="edit-nav">
    ...
    <a href="load.php?id=<?php echo self::FILE; ?>&template=excerpt" class="current"><?php echo i18n_r(self::FILE.'/LABEL_EXCERPT'); ?></a>  
