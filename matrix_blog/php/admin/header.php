<!--header-->
  <h3 class="floated"><?php echo i18n_r(self::FILE.'/TITLE_HEADER'); ?></h3>
  <div class="edit-nav">
    ...
    <a href="load.php?id=<?php echo self::FILE; ?>&template=header" class="current"><?php echo i18n_r(self::FILE.'/LABEL_HEADER'); ?></a> 
    <div class="clear"></div>
  </div>
